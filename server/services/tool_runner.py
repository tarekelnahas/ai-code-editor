...
TOOLS: List[Dict[str, Any]] = [
    # Common System Tools
    {"name": "Git", "category": "Version Control", "command": "git"},
    {"name": "Node.js", "category": "Runtime", "command": "node"},
    {"name": "npm", "category": "Package Manager", "command": "npm"},
    {"name": "Python", "category": "Runtime", "command": "python"},
    {"name": "pip", "category": "Package Manager", "command": "pip"},
    # Linters & Formatters
